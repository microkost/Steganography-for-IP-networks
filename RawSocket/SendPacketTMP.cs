...
namespace RawSocket
{
    public class SendPacketTMP
    {
        ...
        public static void sending(int deviceIndex)
        {
            ...
            */
            ...
            PacketDevice selectedDevice = allDevices[deviceIndex]; //originally deviceIndex - 1
        ...
        private static Packet BuildIpV6Packet()
        {
            ...
            return builder.Build(DateTime.Now); //Additional information: Can't determine ether type automatically from next layer (PcapDotNet.Packets.PayloadLayer)
        }
