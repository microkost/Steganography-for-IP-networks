...
namespace RawSocket
{
    public partial class MainWindow : Form
    {
        ...
        public MainWindow()
        {
            ...
            /*
            foreach (DataS  in collection)
            {

            }
            */

            comboBoxServerAddress.SelectedIndex = 3;

            comboBoxClientAddress.DataSource = Dns.GetHostEntry(Dns.GetHostName()).AddressList;
            comboBoxClientAddress.SelectedIndex = 3;
        ...
        {
            Form MainWindow2 = new MainWindow(); //should have constructor with iterating ports
            MainWindow2.Show();
