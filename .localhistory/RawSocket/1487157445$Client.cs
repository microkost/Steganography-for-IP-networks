        ...
        public void Speaking()
        {
            ...
            do
            {
                ...
                using (PacketCommunicator communicator = Lib.selectedDevice.Open(100, PacketDeviceOpenAttributes.Promiscuous, 1000)) //name of the device //size // promiscuous mode // read timeout
                {
                    ...
                    {                    
                        //SettextBoxDebug("You choose manipulation of IP protocol");
                        IpV4Layer IpV4Layer = new IpV4Layer();
                        IpV4Layer.TypeOfService = Encoding.ASCII.GetBytes("Ahoj světe!");
                    ...
                    else if (String.Equals(StegoMethod, Lib.listOfStegoMethods[2]))
                    {
