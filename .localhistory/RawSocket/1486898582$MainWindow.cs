...
namespace RawSocket
{
    public partial class MainWindow : Form
    {
        ...
        private void buttonSteganogr_Click(object sender, EventArgs e)
        {
            ...
            PacketDevice selectedDevice = allDevices[deviceIndex]; // Take the selected adapter
        ...
        private static void PacketHandler(Packet packet) // Callback function invoked by Pcap.Net for every incoming packet
        {
